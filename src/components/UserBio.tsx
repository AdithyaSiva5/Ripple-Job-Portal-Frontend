...
import {  LocateIcon, Mail, Phone, Target, X} from "lucide-react";
  ...
  return (
    ...
    <div >
      ...
      <div className="bio bg-white w-full h-96 rounded-b-md pt-16 px-10">
        ...
        <p className="text-sm font-bold flex items-center gap-1">{user.profile?.fullname||user.companyProfile?.companyName} </p>
