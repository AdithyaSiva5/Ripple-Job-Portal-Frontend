import { User, ClipboardList, FilePenLine, BarChartBig, Layers3, MessageSquareWarning, CreditCard, Bell } from "lucide-react";
    ...
    return (
        <div className="sidebar-menu w-64   p-4 z-50  bg-white ms-6 mt-5 rounded-lg">
            ...
            <ul className="mt-4  flex-col ">
                ...
                <li className="mb-1 group">
                    <a onClick={() => { navigate('/admin/reports') }}
                        className={`flex font-semibold items-center gap-1 py-3 px-4  hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-950 group-[.active]:text-white ${location.pathname === "/admin/reports" ? "bg-gray-950 text-gray-100" : ""
                ...
                <li className="mb-1 group">
                    <a onClick={() => { navigate('/admin/transactions') }}
                        className={`flex font-semibold items-center gap-1 py-3 px-4  hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-950 group-[.active]:text-white ${location.pathname === "/admin/transactions" ? "bg-gray-950 text-gray-100" : ""
          ...
          <a onClick={() => { navigate('/admin/notifications') }}
            className={`flex font-semibold items-center gap-1 py-3 px-4  hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-950 group-[.active]:text-white ${location.pathname === "/admin/notifications" ? "bg-gray-950 text-gray-100" : ""
