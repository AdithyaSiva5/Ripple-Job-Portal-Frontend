      ...
      <div className="bg-primary pt-8 ">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-6 text-sm leading-8 text-gray-600 dark:text-white">A Premium Membership to get More Job opportunities , priotity color and ofcourse connect more people</p>
          </div>
          <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              <p className="mt-6 text-xs leading-7 text-gray-600 dark:text-white">Lorem ipsum dolor sit amet consect etur adipisicing elit. Itaque amet indis perferendis blanditiis repellendus etur quidem assumenda.</p>
