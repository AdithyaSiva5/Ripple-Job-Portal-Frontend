...
import { darkMode,click } from "../../../utils/context/reducers/darkmodeSlice";
      ...
      <div >
            <div className='w-[100%] h-[60vh] flex flex-col items-center justify-center'>
                <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-[2rem]'>
                    <div>
                        <h1 className='text-[20px] md:text-[28px]  lg:text-[45px] text-[#05264e] dark:text-onBackground leading-[3rem] lg:leading-[4rem] font-extrabold'>The <span className='text-green-500'>Easiest Way</span><br /> To  Get Your New Job</h1>
                        <p className='text-[#4f5e64] text-[14px] md:text-[16px] lg:text-[18px] mt-4 dark:text-gray-400'>Each month, more than 3 million job seekers turn to website in their search for work, making over 140,000 applications every single day</p>
                        <div className='mt-[1.5rem]'>
                            ...
                            <button className='px-5 py-4 outline-none rounded-r-md bg-green-500 text-white'>Search</button>
                        </div>
                    </div>
                    <div className='hidden lg:block'>
                        <img src={hero} alt='hero' width={700} height={400} />
                    </div>
                </div>
            </div>
        </div>
...
<div className="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
  ...
  <svg className="h-8 fill-current text-green-600" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 316 60">
  ...
  <svg className="h-10 fill-current text-green-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 266 100">
  ...
  <div className="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
  <svg className="mt-2 h-6 fill-current text-green-600" viewBox="0 0 398 120" xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="nonzero">
  ...
  <div className="col-span-1 flex items-center justify-center md:col-span-2 lg:col-span-1">
  <svg className="mt-1 h-3 fill-current text-green-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 278.7 36.3">
  ...
  <svg className="h-5 fill-current text-green-600 " viewBox="0 0 2270 546" xmlns="http://www.w3.org/2000/svg">
            <g fill-rule="evenodd">
