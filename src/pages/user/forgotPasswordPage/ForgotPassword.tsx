...
function ForgotPassword() {
  ...
  return (
    <div className="flex min-h-screen bg-primary overflow-hidden">
      <div id="forgot" className="hidden login lg:flex items-center justify-center flex-1  text-black bg-primary" >
      ...
      <div className="w-full  lg:w-1/2 flex items-center justify-center ">
        ...
        <div className="max-w-md w-full p-6" >
          <p className="title text-4xl font-black  mb-2 text-black dark:text-white ">Forgot Password.</p>
