...
function AdminStats() {
    ...
    return (
        <div className="flex flex-col  items-center h-[100vh] pt-4 w-full bg-gray-100">
            <div className="min-w-[375px] md:min-w-[700px] xl:min-w-[800px] bg-red-600mt-3 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-3 3xl:grid-cols-6 w-full px-20">
